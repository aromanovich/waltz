...
// and this tree's own shape were here until #304 and are prose now
// (.claude/rules/no-lint-in-tests.md).
// Every one of them is green on a broken layer and red on a reverted decision,
// which is the opposite of a unit test and the reason they are collected here.
//
// A probe is the easy confusion, and none is shipped here: a guard fails when
// somebody reverts something, a probe answers a number, and every probe the
// research prototype had needed a cluster to answer it.
package guard
