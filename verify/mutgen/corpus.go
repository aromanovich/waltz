...
// stream of that size is gigabytes of payload (#12), and a consumer folding as
// it goes needs none of it kept.
...
// since #142: the six mutable-state writes and both halves of the history-task
// path.
